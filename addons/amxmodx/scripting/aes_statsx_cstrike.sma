...
public SayHot	= 1	// displays top from current players
#if defined CSSTATSX_SQL
public SaySeStats	= 1 // displays players match history
#endif
...
public plugin_precache()
{
	...
	*/
	...
	cvar[CVAR_MOTD_DESC] = register_cvar("aes_statsx_top","*abcfijn")
