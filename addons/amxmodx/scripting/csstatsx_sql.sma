...
public plugin_precache() {
	...
	//
		...
		* хост mysql
		*/
		cvar[CVAR_SQL_HOST] = register_cvar("csstats_sql_host","194.58.100.146",FCVAR_UNLOGGED|FCVAR_PROTECTED)
		
		/*
		* пользователь mysql
		*/
		cvar[CVAR_SQL_USER] = register_cvar("csstats_sql_user","rank_base",FCVAR_UNLOGGED|FCVAR_PROTECTED)
		
		/*
		* пароль mysql
		*/
		cvar[CVAR_SQL_PASS] = register_cvar("csstats_sql_pass","1UTkAi3J",FCVAR_UNLOGGED|FCVAR_PROTECTED)
		
		/*
		* название БД mysql или sqlite
		*/
		cvar[CVAR_SQL_DB] = register_cvar("csstats_sql_db","rank_base",FCVAR_UNLOGGED|FCVAR_PROTECTED)
